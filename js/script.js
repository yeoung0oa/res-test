let funcObj = {
  ...
  f_1:function(){
    ...
    //.count 클래스의 요소가 data-count 속성에 설정된 숫자까지 3초동안 점점 숫자가 증가하는 카운트 애니메이션
    ...
    $(function(){
      $('.count').each(function(){//각각의 요소들을 반복적으로 순회(자바스크립트의 forEach와 동일)
        ...
        $({
          ...
          countNum:countTo //countNum속성을 countTo 값까지 애니메이션
        }, {
          duration: 3000,
          easing:'linear',
...
그래서 outHeigh만큼 미리 앞당겨서 인식 -> 뷰포트에 다 들어오기 전에 이미 동작
